  ...
  <div>
    ...
    <el-table style="width: 100%" border :data="records">
      ...
      <el-table-column label="默认图片" width="110">
        <template slot-scope="{ row, $index }">
          <img :src="row.skuDefaultImg" alt="" width="80" />
        </template>
      </el-table-column>
    ...
    <el-drawer :visible.sync="show" :show-close="false" size="50%">
      ...
      <el-row>
        <el-col :span="5">名称</el-col>
        <el-col :span="16">
          <el-carousel height="460px" width="500">
            <el-carousel-item v-for="item in skuInfo.skuImageList" :key="item.id">
              <img :src="item.imgUrl" alt="" width="512">
            </el-carousel-item>
          </el-carousel>
        </el-col>
      </el-row>
...
/* 三个箭头代表样式穿透，加了scoped一样能影响样式  less是/deep/ scss v-deep*/
>>>.el-carousel__button{
    width: 10px;
    height: 10px;
